...
@rem ##########################################################################
@rem
@rem  schemadocs startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and SCHEMADOCS_OPTS to pass JVM options to this script.
...
@rem Execute schemadocs
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SCHEMADOCS_OPTS%  -classpath "%CLASSPATH%" edu.sc.seis.sod.validator.documenter.SchemaDocumenter %*
...
:fail
rem Set variable SCHEMADOCS_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
set EXIT_CODE=%ERRORLEVEL%
if %EXIT_CODE% equ 0 set EXIT_CODE=1
if not ""=="%SCHEMADOCS_EXIT_CONSOLE%" exit %EXIT_CODE%
exit /b %EXIT_CODE%
