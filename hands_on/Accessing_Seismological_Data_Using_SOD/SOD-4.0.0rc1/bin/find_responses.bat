...
@rem ##########################################################################
@rem
@rem  find_responses startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and FIND_RESPONSES_OPTS to pass JVM options to this script.
...
@rem Execute find_responses
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %FIND_RESPONSES_OPTS%  -classpath "%CLASSPATH%" edu.sc.seis.sod.tools.find_responses %*
...
:fail
rem Set variable FIND_RESPONSES_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
set EXIT_CODE=%ERRORLEVEL%
if %EXIT_CODE% equ 0 set EXIT_CODE=1
if not ""=="%FIND_RESPONSES_EXIT_CONSOLE%" exit %EXIT_CODE%
exit /b %EXIT_CODE%
